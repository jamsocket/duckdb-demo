module.exports = {
  ...
  importPath: 'https://storage.googleapis.com/jamsocket-demo-data/citibike-10M.csv.gz', // or 'https://storage.googleapis.com/jamsocket-demo-data/2018-2020-citibike-trips.csv.gz',
